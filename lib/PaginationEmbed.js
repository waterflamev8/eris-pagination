...
class PaginationEmbed {
     ...
     */
    update() {
        const embed = this.pages[this.page - 1];
        embed.footer = {};
        embed.footer.text = this.showPages
            ? `Use the reactions to flip pages. (Page ${this.page}/${this.pages.length})`
                    ...
                    if (this.advanced) {
                        return new Promise(resolve => {
                            if (this.checkPerms()) {
                                ...
                                [this.firstPage, this.back, this.delete, this.forth, this.lastPage].forEach(reaction => {
